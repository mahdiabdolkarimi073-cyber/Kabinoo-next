...
import { Button, TextInput, Textarea, NumberInput, Group, Text, ActionIcon } from "@mantine/core";
...
export default function Page() {
    ...
    const { data, loading: l5 } = !isN ? useBackend<Article>(`/admin/article/${id}`) : { data: undefined, loading: false };
        ...
        <div className="flex flex-col gap-4 my-6">
            ...
            <div className="center mt-4">
                <Button
                    ...
                    onClick={() => {
                        setLoading(true);
                        backend("/admin/article", isN ? "POST" : "PUT", article).then((e) => {
                            setLoading(false);
                            if (!e.ok) return;
                            if (isN) {
