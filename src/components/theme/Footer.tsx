...
function Footer(props: any) {
    return (
        <div className={'bg-black'}>
            <footer className="bg-accent/40 text-gray-300 py-8 md:py-10 px-4 md:px-8 lg:px-12 font-inter mt-8 md:mt-16">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">کابینت و دکوراسیون کابینو</h3>
                        ...
                        <p className="mb-2 text-sm md:text-base">انواع کابینت و کمد دیواری و دکوراسیون منزل و مغازه</p>
                        <p className="mb-4 text-sm md:text-base">اقساط 36 ماهه</p>
                        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-4">
                            <a href="https://wa.me/989133448865" target="_blank" rel="noopener noreferrer"
                               className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-600 rounded-full flex items-center justify-center hover:bg-gray-500 transition-colors">
                                <IconBrandWhatsapp/>
                            </a>
                        ...
                        <div className="flex flex-col items-center md:items-end text-center md:text-right">
                            <a href="tel:09133448865" target="_blank" rel="noopener noreferrer"
                               className="flex items-center mb-2 hover:underline">
                                <span className="ml-2 text-base md:text-lg">09133448865</span>
                                <IconPhone/>
                            </a>
                            <a href="tel:09136645960" target="_blank" rel="noopener noreferrer"
                               className="flex items-center mb-2 hover:underline">
                                <span className="ml-2 text-base md:text-lg">09136645960</span>
                                <IconPhone/>
                            </a>
                            <a href="https://instagram.com/Ebtekar.5960" target="_blank" rel="noopener noreferrer"
                               className="flex items-center mb-2 hover:underline">
                                <span className="ml-2 text-base md:text-lg">Ebtekar.5960</span>
                                <IconBrandInstagram/>
                            </a>
                            <a href="mailto:kabinoo5960@gmail.com" target="_blank" rel="noopener noreferrer"
                               className="flex items-center hover:underline">
                                <span className="ml-2 text-base md:text-lg" dir="ltr">kabinoo5960@gmail.com</span>
                                <IconMail/>
                            </a>
                        </div>
                        <iframe
                            ...
                            className={'w-32 h-32 sm:w-40 sm:h-40 md:w-44 md:h-44 lg:w-48 lg:h-48 mx-auto rounded-xl overflow-hidden'}
                            style={{ border: 0 }}
                            loading="lazy"
                ...
                {/* Copyright Section */}
                <div className="border-t border-gray-600 mt-6 md:mt-8 pt-4 text-xs sm:text-sm text-gray-400">
                    <div className="flex items-center justify-between gap-4 flex-col lg:flex-row px-2 md:px-5 mx-auto text-center">
