...
"[project]/frontend/src/app/(landing)/admin/user/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    const [filters, setFilters] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$mantine$2f$hooks$2f$esm$2f$use$2d$debounced$2d$state$2f$use$2d$debounced$2d$state$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDebouncedState"])({
        name: "",
        phone: "",
        email: "",
        nationalCode: "",
    ...
    const { data: users = null, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$hooks$2f$useBackend$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])("/admin/users?" + new URLSearchParams(Object.fromEntries(Object.entries(filters).filter(([_, v])=>v))).toString());
    if (users === null) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$no$2d$side$2f$Loading$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/frontend/src/app/(landing)/admin/user/page.tsx",
        lineNumber: 37,
        columnNumber: 32
    }, this);
    const tableHead = [
...
//# sourceMappingURL=frontend_src_d9212080._.js.map