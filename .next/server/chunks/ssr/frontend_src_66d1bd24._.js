...
"[project]/frontend/src/app/(landing)/admin/author/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    ...
    const { data: authors = null, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$hooks$2f$useBackend$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])("/admin/author?" + new URLSearchParams(Object.fromEntries(Object.entries(filters).filter(([, v])=>v))).toString());
    const handleRemoveAuthor = async (authorId, authorName)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$ui$2f$modalUtils$2f$confirm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["askConfirm"])(`آیا می‌خواهید دسترسی نویسندگی "${authorName}" را بگیرید؟`);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["backend"])(`/admin/author/${authorId}`, "PUT", {
                isAuthor: false
            });
...
//# sourceMappingURL=frontend_src_66d1bd24._.js.map