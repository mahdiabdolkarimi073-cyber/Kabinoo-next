...
"[project]/frontend/src/app/(main)/auth/password/ResetPassword.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ResetPassword(props) {
    ...
    const [repeatPassword, setRepeatPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["backend"])("/auth/password", "POST", {
                phone: props.phone,
                password: password
            });
            if (res.ok) {
                ...
                setRepeatPassword("");
                if (props.onSuccess) {
                    var _props_onSuccess;
                    (_props_onSuccess = props.onSuccess) === null || _props_onSuccess === void 0 ? void 0 : _props_onSuccess.call(props);
                } else {
                    var _res_data;
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$app$2f28$main$292f$auth$2f$data$3a$34eeb0__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["setUserCookie"])((res === null || res === void 0 ? void 0 : (_res_data = res.data) === null || _res_data === void 0 ? void 0 : _res_data.token) || window.throw("خطا در لاگین")).then(()=>{
                        router.push('/user');
                    });
                }
            }
...
_s(ResetPassword, "wDPeP4wHbiSAa0mccWPcJD7ajSk=", false, function() {
    return [
...
//# sourceMappingURL=frontend_b9f6166b._.js.map