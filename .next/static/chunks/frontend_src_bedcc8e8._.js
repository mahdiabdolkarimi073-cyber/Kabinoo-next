...
"[project]/frontend/src/app/(landing)/admin/user/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    ...
    const { data: users = null, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$hooks$2f$useBackend$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("/admin/users?" + new URLSearchParams(Object.fromEntries(Object.entries(filters).filter({
...
_s(Page, "QPf/0I1rPVVh6tgF2kh8l6TfS+U=", false, function() {
    return [
...
//# sourceMappingURL=frontend_src_bedcc8e8._.js.map